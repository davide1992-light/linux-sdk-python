...
class CustomMicrophone:
    """Custom microphone class for audio streaming and chunking.

    Handles audio input stream setup, buffer queueing, and chunk generation.
    """
    ...
    def __init__(
        ...
        """Initialize the CustomMicrophone.
    ...
    def __enter__(self):
        ...
        Returns:
            CustomMicrophone: Self instance for use with context manager.
        """
        if not self.interface:
            self.interface = pyaudio.PyAudio()
...
class CustomAudioImpulseRunner(ImpulseRunner):
    """Real-time audio classifier using a microphone and Edge Impulse."""

    def __init__(self, model_path: str):
        """Initialize the CustomAudioImpulseRunner.

        Args:
            model_path (str): Path to the Edge Impulse .eim model file.
        """
        super(CustomAudioImpulseRunner, self).__init__(model_path)
        self.closed = True
    ...
    def init(self, debug: bool | None = False) -> Dict:
        ...
        """
        model_info = super(CustomAudioImpulseRunner, self).init(debug)
    ...
    def __enter__(self):
        ...
        Returns:
            CustomAudioImpulseRunner: Self instance.
        """
        self.closed = False
        return self
    ...
    def classify(self, data: List) -> Dict:
        ...
        """
        return super(CustomAudioImpulseRunner, self).classify(data)
    ...
    def _setup_microphone(self, device_id: int | None = None) -> CustomMicrophone:
        ...
        Returns:
            CustomMicrophone: Initialized microphone instance.

        Raises:
            Exception: If microphone setup fails.
        """
        return CustomMicrophone(self.sampling_rate, CHUNK_SIZE, device_id=device_id)
